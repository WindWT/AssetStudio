        ...
        private void exportFolder_Click(object sender, EventArgs e) {
            ...
            if (openFolderDialog.ShowDialog(this) == DialogResult.OK) {
                ...
                if (saveFolderDialog1.ShowDialog(this) == DialogResult.OK) {
                    ...
                    ThreadPool.QueueUserWorkItem(state =>
                    {
                        var di = new DirectoryInfo(openFolderDialog.Folder);
                        ...
                        foreach (var file in files.OrderBy(o=>Guid.NewGuid())) {
                            ...
                            if (tempSize >= 512 * 1024 * 1024 || i + 1 == files.Count) {
                                ...
                                ExportAssetsSync(saveFolderDialog1.Folder, toExportAssets,
                                    assetGroupOptions.SelectedIndex);
                        ...
                        if (openAfterExport.Checked) {
                            Process.Start(saveFolderDialog1.Folder);
                        }
                    });
                }
            }
